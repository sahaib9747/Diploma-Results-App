                ...
                <div class="login-div">
                    <div class="login-heading">
                        ...
                        WELCOME TO LOGIN PANEL</h2>
                                <?php 
                    if(isset($_POST['login'])){
                                if($UserName != $username and $Email != $username and $Password != $password){  ?>
                                    <p class="login-heading-msg">
                                    <?php echo"Your username/email and password is invalid"; 
                                }
                                ?>
                                    </p>
                                <?php if(($username == $UserName or $username == $Email) and $password != $Password  )
                                { ?>
                                <p>
                                    <?php echo "Password did not match";
                                    }  ?>
                                </p>
                        <?php
                     } 
